...
import com.example.jaycee.mdpobjectsearch.helpers.TGAReaderHelper;
...
public class ObjectRenderer
{
    ...
    private int materialParameterUniform;
    private int colourCorrectionParameterUniform;


    private final int[] textures = new int[1];

    private float ambient = 0.3f;
    private float diffuse = 1.f;
    private float specular = 1.f;
    private float specularPower = 6.f;
    ...
    public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName) throws IOException
    {
        final int vertexShader =
                ShaderUtils.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
        final int fragmentShader =
                ShaderUtils.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
        ...
        materialParameterUniform = GLES20.glGetUniformLocation(program, "u_MaterialParameters");
        colourCorrectionParameterUniform =
...
/*        scaleMatrix[0] = scaleFactor;
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, float[] colourCorrectionRgba)
    {
        ...
        GLES20.glUniform4f(
                colourCorrectionParameterUniform,
                colourCorrectionRgba[0],
                colourCorrectionRgba[1],
                colourCorrectionRgba[2],
                colourCorrectionRgba[3]);

        // Set the object material properties.
        GLES20.glUniform4f(materialParameterUniform, ambient, diffuse, specular, specularPower);
