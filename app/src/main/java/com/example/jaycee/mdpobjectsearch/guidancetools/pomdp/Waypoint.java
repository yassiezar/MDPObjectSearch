...
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.ANGLE_INTERVAL;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.A_DOWN;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.A_LEFT;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.A_RIGHT;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.A_UP;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.GRID_SIZE_PAN;
import static com.example.jaycee.mdpobjectsearch.guidancetools.Params.GRID_SIZE_TILT;
...
class Waypoint
{
    ...
    void updateWaypoint(long action, Session session, float cameraPan, float cameraTilt, float cameraZ)
    {
        ...
        wayPointTranslation[2] = -(float)Math.cos(Math.toRadians(ANGLE_INTERVAL*(pan - GRID_SIZE_PAN/2 + 1)));//z;
